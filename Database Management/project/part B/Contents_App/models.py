...
class Actorsinmovies(models.Model):
    aname = models.CharField(db_column='aName', primary_key=True, max_length=50)
    mtitle = models.ForeignKey('Movies', models.DO_NOTHING, db_column='mTitle')
...
class Users(models.Model):
    ...
    favactor = models.CharField(db_column='favActor', max_length=50, blank=True, null=True)
